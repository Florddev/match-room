...
import { Calendar, Clock, MapPin, Home, ArrowRight, Loader2 } from "lucide-react"
        ...
        return (
            <div className="min-h-screen flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="mt-4 text-lg text-gray-600">Chargement de vos réservations...</p>
                </div>
            </div>
        )
    }
    ...
    return (
        <div className="container mx-auto py-10 px-4">
            <div className="mb-8">
                ...
                <p className="text-gray-500 mt-2">Consultez et gérez vos réservations</p>
            </div>

            {bookings.length === 0 ? (
                <div className="text-center py-16 bg-gray-50 rounded-lg border border-dashed border-gray-300">
                    <Home className="h-12 w-12 mx-auto text-gray-400 mb-4" />
                    <h3 className="text-xl font-semibold text-gray-700 mb-2">Aucune réservation pour le moment</h3>
                    <p className="text-gray-500 mb-6 max-w-md mx-auto">
                        Vous n'avez pas encore de réservation. Explorez nos chambres et réservez votre prochain séjour.
                    </p>
                        ...
                        return (
                            <Card key={booking.id} className="overflow-hidden">
                                <div className="aspect-video relative">
                                    <img src="/hotel.jpg" alt={booking.room.name} className="w-full h-full object-cover" />
                                ...
                                <CardContent className="space-y-4">
                                    ...
                                    <div className="flex items-start space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-500">
                                                {booking.room.hotel.address}, {booking.room.hotel.city} {booking.room.hotel.zipCode}
                                            </p>
                                        </div>
                                    </div>
